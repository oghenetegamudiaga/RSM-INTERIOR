  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        {/* 3 Testimonial Cards Matching Wireframe Page 2 */}
        <div
          id="reviews-grid"
        ...
        >
          {REVIEWS.map((rev) => (
            <div
              ...
              className="bg-[#FAF9F5] border border-[#E7E5E4] rounded-xl p-8 flex flex-col justify-between hover:border-[#9B815B] transition-colors"
            >
